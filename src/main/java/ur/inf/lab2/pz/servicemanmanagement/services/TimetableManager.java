...
public class TimetableManager {
    ...
    private class ServicemanTaskEditDialogData implements TimetableTaskEditDialogData {
        ...
        public ServicemanTaskEditDialogData(Parent dialogBody, StackPane stackPane) {
            this.dialogBody = dialogBody;
            this.stackPaneForDialog = stackPane;
        ...
        @Override
        public void setTaskDescription(String description) {
            ((Label) findNodeInDialogBody(DESCRIPTION_NODE_ID)).setText(description);
        }
        ...
        @Override
        public void setDateTimeFrom(LocalDateTime dateTimeFrom) {
            ((Label) findNodeInDialogBody(DATE_FROM_NODE_ID)).setText(dateTimeFrom.toLocalDate().toString());
            ((Label) findNodeInDialogBody(TIME_FROM_NODE_ID)).setText(dateTimeFrom.toLocalTime().toString());
        }
        ...
        @Override
        public void setDateTimeTo(LocalDateTime dateTimeTo) {
            ((Label) findNodeInDialogBody(DATE_TO_NODE_ID)).setText(dateTimeTo.toLocalDate().toString());
            ((Label) findNodeInDialogBody(TIME_TO_NODE_ID)).setText(dateTimeTo.toLocalTime().toString());
        }
        ...
        @Override
        public TaskState getState() {
            String enumName = getStateButton().getText();

            for (TaskState value : TaskState.values()) {
                if (value.getName().equalsIgnoreCase(enumName))
                    return value;
            }
        ...
        @Override
        public Button getStateButton() {
            return ((Button) findNodeInDialogBody(STATE_BUTTON_ID));
        }
