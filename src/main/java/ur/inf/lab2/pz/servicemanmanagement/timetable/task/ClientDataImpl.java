...
public class ClientDataImpl implements ClientData {
    ...
    public ClientDataImpl(String firstName, String surname, String phoneNumber, String street, String houseNumber, String flatNumber, String city) {
    ...
    public ClientDataImpl(Task task) {
